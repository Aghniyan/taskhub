...
<body class="bg-[#FAFAF8] text-gray-900 antialiased" style="font-family:'Inter',system-ui,sans-serif;"
    ...
    <div class="flex min-h-screen">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="px-4 flex-1 overflow-y-auto">
              ...
              {{ request()->routeIs('dashboard')
                  ...
                  : 'text-[#8A8A8E] hover:bg-[#FAFAF8] hover:text-[#1C1C1E]' }}">
              ...
              {{ request()->routeIs('projects.*')
                  ...
                  : 'text-[#8A8A8E] hover:bg-[#FAFAF8] hover:text-[#1C1C1E]' }}">
                        ...
                        @if ($pc > 0)
                            <span
                                class="ml-auto text-[11px] font-semibold px-[7px] py-[1px] rounded-full
            ...
            border-t border-[#ECECE9] mt-auto">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="text-[#B8B8B5] hover:text-[#F87171] hover:bg-[#FEEAEA]
        ...
        <div class="flex-1 flex flex-col min-w-0 lg:ml-[248px]">
            ...
            <header
                class="sticky top-0 z-30 bg-white border-b border-[#ECECE9]
                   flex items-center gap-4 px-9 py-5">

                {{-- Tombol hamburger — hanya muncul di mobile (lg:hidden) --}}
                <button
                    class="lg:hidden text-[#8A8A8E] hover:text-[#1C1C1E]
